...
namespace HairSalon.Models
{
    public class Stylist
    {
        ...
        public List<Client> GetClients()
        {
          ...
          conn.Open();
          var cmd = conn.CreateCommand() as MySqlCommand;
          cmd.CommandText = @"SELECT clients.* FROM stylist
          JOIN stylist_clients ON (stylist.id = stylist_clients.stylist_id)
          JOIN clients ON (stylist_clients.clients_id = clients.id)
        ...
        public void Delete()
        {
            MySqlConnection conn = DB.Connection();
            conn.Open();
            MySqlCommand cmd = new MySqlCommand("DELETE FROM stylist Where id = @StylistId; DELETE FROM stylist_clients WHERE stylist_id = @StylistId;", conn);
            MySqlParameter stylistId = new MySqlParameter();
        ...
        public void Edit(string editName)
        {
            ...
            conn.Open();
            var cmd = conn.CreateCommand() as MySqlCommand;
            cmd.CommandText = @"UPDATE stylist SET name = @editName WHERE id = @searchId;";
            MySqlParameter searchId = new MySqlParameter();
            searchId.ParameterName = "@searchId";
            searchId.Value = _id;
            cmd.Parameters.Add(searchId);
